...
const LANG = {
  zh: {
    ...
    notifications: "通知", nav: ["探索", "地圖", "預訂", "通知", "帳戶"],
    ...
    cancelMsg: "預訂已取消", available: "有空房", unavailable: "已額滿",
    yourBookings: "我的預訂", noBookings: "尚無預訂記錄",
  ...
  en: {
    ...
    notifications: "Notifications", nav: ["Explore", "Map", "Bookings", "Alerts", "Account"],
    ...
    cancelMsg: "Booking cancelled", available: "Available", unavailable: "Sold Out",
    yourBookings: "My Bookings", noBookings: "No bookings yet",
...
const HOTELS = [
  { id:1, name:{zh:"台北君悅大酒店",en:"Grand Hyatt Taipei"}, city:{zh:"台北",en:"Taipei"}, cityKey:"taipei", stars:5, rating:4.8, reviewCount:2340, pricePerNight:18500, distanceKm:1.2, lat:25.0408, lng:121.5654,
    ...
    description:{zh:"台北最具代表性的五星級豪華飯店，坐落於信義商圈核心地帶。每間套房均提供城市全景，配備精緻衛浴與頂級寢具。",en:"Taipei's most iconic five-star hotel in the heart of Xinyi District with panoramic city views."},
    ...
    reviews:[{name:"Sophia W.",rating:5,date:"2025-11",text:{zh:"無可挑剔的服務，景觀絕美！",en:"Impeccable service and stunning views!"},avatar:"SW"}],
  ...
  { id:3, name:{zh:"香港四季酒店",en:"Four Seasons Hong Kong"}, city:{zh:"香港",en:"Hong Kong"}, cityKey:"hongkong", stars:5, rating:4.7, reviewCount:1876, pricePerNight:24000, distanceKm:0.5, lat:22.2830, lng:114.1588,
    ...
    amenities:[0,1,2,3,4],
    description:{zh:"位於中環金融核心，坐擁維多利亞港無敵海景，絢爛夜景與無微不至的服務。",en:"In the heart of Central with unobstructed Victoria Harbour views and dazzling nightscapes."},
  ...
  { id:4, name:{zh:"首爾新羅飯店",en:"The Shilla Seoul"}, city:{zh:"首爾",en:"Seoul"}, cityKey:"seoul", stars:5, rating:4.6, reviewCount:1423, pricePerNight:15000, distanceKm:2.1, lat:37.5516, lng:126.9982,
  ...
  { id:5, name:{zh:"新加坡濱海灣金沙",en:"Marina Bay Sands"}, city:{zh:"新加坡",en:"Singapore"}, cityKey:"singapore", stars:5, rating:4.5, reviewCount:5674, pricePerNight:20000, distanceKm:0.9, lat:1.2834, lng:103.8607,
  ...
  { id:6, name:{zh:"曼谷文華東方",en:"Mandarin Oriental Bangkok"}, city:{zh:"曼谷",en:"Bangkok"}, cityKey:"bangkok", stars:5, rating:4.9, reviewCount:2891, pricePerNight:12000, distanceKm:1.5, lat:13.7238, lng:100.5123,
  ...
  { id:7, name:{zh:"杜拜帆船酒店",en:"Burj Al Arab Dubai"}, city:{zh:"杜拜",en:"Dubai"}, cityKey:"dubai", stars:5, rating:4.9, reviewCount:4210, pricePerNight:98000, distanceKm:0.3, lat:25.1412, lng:55.1853,
    ...
    description:{zh:"全球最豪華的帆船形地標酒店，私人島嶼上的頂級雙層套房，配備黃金裝飾與私人管家服務。",en:"The world's most luxurious sail-shaped hotel on a private island. Every duplex suite features gold accents and a personal butler."},
    rooms:[{name:{zh:"豪華套房",en:"Deluxe Suite"},price:98000,available:true},{name:{zh:"全景套房",en:"Panoramic Suite"},price:165000,available:true},{name:{zh:"皇家套房",en:"Royal Suite"},price:980000,available:false}],
    reviews:[{name:"Mohammed A.",rating:5,date:"2025-11",text:{zh:"人生中最奢華的住宿體驗，無可超越。",en:"The most luxurious experience of my life, unmatched."},avatar:"MA"}],
    nearby:[{zh:"朱美拉海灘 (0.1 km)",en:"Jumeirah Beach (0.1 km)"},{zh:"棕櫚島 (5.0 km)",en:"Palm Jumeirah (5.0 km)"}]
  },
  { id:8, name:{zh:"巴黎麗茲酒店",en:"The Ritz Paris"}, city:{zh:"巴黎",en:"Paris"}, cityKey:"paris", stars:5, rating:4.9, reviewCount:3560, pricePerNight:85000, distanceKm:0.2, lat:48.8683, lng:2.3308,
    ...
    amenities:[0,1,2,3,6],
    description:{zh:"坐落於旺多姆廣場的傳奇酒店，自1898年起接待全球皇室與名流，每間套房均為手工藝術品。",en:"The legendary Place Vendôme hotel since 1898, hosting royalty and celebrities. Every suite is a work of art."},
    rooms:[{name:{zh:"豪華套房",en:"Deluxe Suite"},price:85000,available:true},{name:{zh:"皇家套房",en:"Imperial Suite"},price:180000,available:true},{name:{zh:"香奈兒套房",en:"Coco Chanel Suite"},price:320000,available:false}],
    reviews:[{name:"Isabelle M.",rating:5,date:"2025-11",text:{zh:"巴黎最頂級的住宿，每個細節都是藝術。",en:"Paris at its finest — every detail is art."},avatar:"IM"}],
    nearby:[{zh:"旺多姆廣場 (0.1 km)",en:"Place Vendôme (0.1 km)"},{zh:"羅浮宮 (0.8 km)",en:"The Louvre (0.8 km)"}]
  },
  { id:9, name:{zh:"紐約廣場飯店",en:"The Plaza New York"}, city:{zh:"紐約",en:"New York"}, cityKey:"newyork", stars:5, rating:4.7, reviewCount:4890, pricePerNight:72000, distanceKm:0.5, lat:40.7645, lng:-73.9741,
    ...
    amenities:[0,1,2,3,6],
    description:{zh:"俯瞰中央公園的傳奇地標，自1907年起象徵紐約奢華精髓，金碧輝煌的大廳與精緻套房。",en:"Overlooking Central Park since 1907, the epitome of New York luxury with grand gilded halls."},
    ...
    reviews:[{name:"Michael B.",rating:5,date:"2025-11",text:{zh:"中央公園景觀讓人心曠神怡，服務一流。",en:"Central Park views are breathtaking, service is first-class."},avatar:"MB"}],
    nearby:[{zh:"中央公園 (0.1 km)",en:"Central Park (0.1 km)"},{zh:"第五大道 (0.2 km)",en:"Fifth Avenue (0.2 km)"}]
  },
  { id:10, name:{zh:"倫敦薩伏依酒店",en:"The Savoy London"}, city:{zh:"倫敦",en:"London"}, cityKey:"london", stars:5, rating:4.8, reviewCount:3120, pricePerNight:65000, distanceKm:0.7, lat:51.5104, lng:-0.1204,
    ...
    description:{zh:"坐落泰晤士河畔，自1889年起接待英國皇室，裝飾藝術風格與英式典雅服務的完美結合。",en:"On the Thames since 1889, hosting British royalty. Perfect blend of Art Deco style and British elegance."},
    ...
    reviews:[{name:"Charlotte H.",rating:5,date:"2025-11",text:{zh:"英式優雅的極致體現，服務令人動容。",en:"The ultimate in British elegance, service is deeply moving."},avatar:"CH"}],
    nearby:[{zh:"泰晤士河 (0.1 km)",en:"River Thames (0.1 km)"},{zh:"特拉法加廣場 (0.5 km)",en:"Trafalgar Square (0.5 km)"}]
  },
  { id:11, name:{zh:"馬爾地夫索尼娃芙西島",en:"Soneva Fushi Maldives"}, city:{zh:"馬爾地夫",en:"Maldives"}, cityKey:"maldives", stars:5, rating:4.9, reviewCount:1876, pricePerNight:120000, distanceKm:0.0, lat:5.1130, lng:73.0331,
    ...
    description:{zh:"坐落印度洋私人珊瑚礁島嶼，水上別墅直接架設於碧藍海水之上，無電視無鞋政策讓您沉浸於自然奢華。",en:"A private coral reef island in the Indian Ocean with water villas directly over turquoise waters."},
    ...
    reviews:[{name:"Priya S.",rating:5,date:"2025-11",text:{zh:"人生中最美好的假期，天堂般的體驗。",en:"The most beautiful holiday of my life — paradise."},avatar:"PS"}],
    nearby:[{zh:"珊瑚礁潛水 (0.1 km)",en:"Coral Reef Diving (0.1 km)"},{zh:"私人沙灘 (0.0 km)",en:"Private Beach (0.0 km)"}]
  },
  { id:12, name:{zh:"羅馬伊甸園酒店",en:"Hotel Eden Rome"}, city:{zh:"羅馬",en:"Rome"}, cityKey:"rome", stars:5, rating:4.8, reviewCount:2103, pricePerNight:42000, distanceKm:0.8, lat:41.9028, lng:12.4964,
    ...
    amenities:[0,1,2,3,6],
    description:{zh:"俯瞰羅馬全景的頂級酒店，自1889年起接待教宗與各國元首，屋頂餐廳提供永恆之城無與倫比的全景。",en:"Overlooking all of Rome since 1889, hosting popes and heads of state with incomparable rooftop views."},
    ...
    reviews:[{name:"Giulia R.",rating:5,date:"2025-11",text:{zh:"屋頂日落景觀讓人屏息，值得每一分錢。",en:"Rooftop sunset views are breathtaking — worth every cent."},avatar:"GR"}],
    nearby:[{zh:"西班牙廣場 (0.3 km)",en:"Spanish Steps (0.3 km)"},{zh:"特雷維噴泉 (0.8 km)",en:"Trevi Fountain (0.8 km)"}]
  },
  { id:13, name:{zh:"上海半島酒店",en:"The Peninsula Shanghai"}, city:{zh:"上海",en:"Shanghai"}, cityKey:"shanghai", stars:5, rating:4.8, reviewCount:2756, pricePerNight:28000, distanceKm:0.3, lat:31.2340, lng:121.4880,
    ...
    amenities:[0,1,2,3,6,7],
    description:{zh:"坐落外灘黃金地段，俯瞰黃浦江與浦東天際線，裝飾藝術風格建築融合現代奢華。",en:"On the Bund's golden strip overlooking the Huangpu River. Art Deco architecture meets modern luxury."},
    ...
    reviews:[{name:"Chen Wei",rating:5,date:"2025-11",text:{zh:"外灘夜景配上頂級服務，完美無缺。",en:"Bund night views with top service — absolutely perfect."},avatar:"CW"}],
    nearby:[{zh:"外灘 (0.1 km)",en:"The Bund (0.1 km)"},{zh:"南京路 (0.5 km)",en:"Nanjing Road (0.5 km)"}]
  },
  { id:14, name:{zh:"雪梨四季酒店",en:"Four Seasons Sydney"}, city:{zh:"雪梨",en:"Sydney"}, cityKey:"sydney", stars:5, rating:4.7, reviewCount:2340, pricePerNight:35000, distanceKm:0.4, lat:-33.8688, lng:151.2093,
    ...
    amenities:[0,1,2,3,4,7],
    description:{zh:"俯瞰雪梨歌劇院與港灣大橋的絕佳位置，每間套房均提供澳洲最著名地標的壯麗景觀。",en:"Overlooking the Sydney Opera House and Harbour Bridge with world-class service."},
    ...
    reviews:[{name:"Sophie A.",rating:5,date:"2025-11",text:{zh:"歌劇院景觀配上早餐，此生難忘！",en:"Opera House views at breakfast — unforgettable!"},avatar:"SA"}],
    nearby:[{zh:"雪梨歌劇院 (0.3 km)",en:"Sydney Opera House (0.3 km)"},{zh:"岩石區 (0.5 km)",en:"The Rocks (0.5 km)"}]
  },
  { id:15, name:{zh:"東京阿曼酒店",en:"Aman Tokyo"}, city:{zh:"東京",en:"Tokyo"}, cityKey:"tokyo", stars:5, rating:5.0, reviewCount:987, pricePerNight:55000, distanceKm:0.5, lat:35.6895, lng:139.6917,
    ...
    amenities:[0,1,2,3,6],
    description:{zh:"坐落大手町森大廈33樓，俯瞰皇居與富士山絕景，融合日本禪意美學與現代奢華，套房面積均超過100平方公尺。",en:"On the 33rd floor of Otemachi Tower with views of the Imperial Palace and Mt. Fuji. All suites exceed 100 sqm."},
    ...
    reviews:[{name:"Yuki T.",rating:5,date:"2025-11",text:{zh:"東京最極致的住宿，禪意與奢華的完美平衡。",en:"Tokyo's ultimate stay — perfect balance of Zen and luxury."},avatar:"YT"}],
    nearby:[{zh:"皇居 (0.3 km)",en:"Imperial Palace (0.3 km)"},{zh:"大手町商業區 (0.1 km)",en:"Otemachi Business District (0.1 km)"}]
  },
];

const CITIES = [
  {zh:"全部城市",en:"All Cities",key:"all"},{zh:"台北",en:"Taipei",key:"taipei"},
  {zh:"東京",en:"Tokyo",key:"tokyo"},{zh:"香港",en:"Hong Kong",key:"hongkong"},
  {zh:"首爾",en:"Seoul",key:"seoul"},{zh:"新加坡",en:"Singapore",key:"singapore"},
  {zh:"曼谷",en:"Bangkok",key:"bangkok"},{zh:"杜拜",en:"Dubai",key:"dubai"},
  {zh:"巴黎",en:"Paris",key:"paris"},{zh:"紐約",en:"New York",key:"newyork"},
  {zh:"倫敦",en:"London",key:"london"},{zh:"馬爾地夫",en:"Maldives",key:"maldives"},
  {zh:"羅馬",en:"Rome",key:"rome"},{zh:"上海",en:"Shanghai",key:"shanghai"},
  {zh:"雪梨",en:"Sydney",key:"sydney"},
];

const NOTIFS_INIT = [
  {id:1,type:"confirm",icon:"✓",color:"#0a7c5c",bg:"#e1f5ee",titleZh:"預訂確認",titleEn:"Booking Confirmed",msgZh:"您的台北君悅套房已確認預訂，入住日期：12/20",msgEn:"Grand Hyatt Taipei suite confirmed. Check-in: Dec 20",time:"2分鐘前"},
  {id:2,type:"price",icon:"↓",color:"#854F0B",bg:"#FAEEDA",titleZh:"價格提醒",titleEn:"Price Alert",msgZh:"帆船酒店今日降價 10%，限時優惠！",msgEn:"Burj Al Arab dropped 10% today — limited time!",time:"1小時前"},
  {id:3,type:"offer",icon:"★",color:"#533AB7",bg:"#EEEDFE",titleZh:"限時優惠",titleEn:"Special Offer",msgZh:"提前 30 天預訂，享 20% 早鳥折扣",msgEn:"Book 30 days ahead for 20% early-bird discount",time:"3小時前"},
  {id:4,type:"price",icon:"↓",color:"#854F0B",bg:"#FAEEDA",titleZh:"價格提醒",titleEn:"Price Alert",msgZh:"馬爾地夫索尼娃水上別墅周末特惠",msgEn:"Soneva Fushi Maldives weekend special offer",time:"昨天"},
